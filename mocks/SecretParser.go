...
// ValidateRepoSecret provides a mock function with given fields: command, secretData
func (_m *SecretParser) ValidateRepoSecret(command string, secretData map[string]string) error {
	ret := _m.Called(command, secretData)
...
// NewSecretParser creates a new instance of SecretParser. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSecretParser(t testing.TB) *SecretParser {
	mock := &SecretParser{}
	mock.Mock.Test(t)
