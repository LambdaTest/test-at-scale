...
func getValidatePayloadTestCases() []*testCaseValidatePayload {
	testCases := []*testCaseValidatePayload{
		...
		},
		{
			...
			validatePayloadArgs{ctx: context.TODO(), payload: &core.Payload{
				RepoLink: "github.com/abc/",
		...
		},
		{
			...
			validatePayloadArgs{ctx: context.TODO(), payload: &core.Payload{
				RepoLink: "github.com/abc/", RepoSlug: "/slug",
		...
		},
		{
			...
			validatePayloadArgs{ctx: context.TODO(), payload: &core.Payload{
				RepoLink: "github.com/abc/", RepoSlug: "/slug",
				GitProvider: "fake", BuildID: "build", RepoID: "repo", BranchName: "",
			}},
			true,
		},
		{
		...
		},
		{
			...
			validatePayloadArgs{
				ctx: context.TODO(), payload: &core.Payload{
					RepoLink: "github.com/abc/", RepoSlug: "/slug",
		...
		},
		{
			...
			validatePayloadArgs{ctx: context.TODO(), payload: &core.Payload{
				RepoLink: "github.com/abc/", RepoSlug: "/slug",
				GitProvider: "fake", BuildID: "build", RepoID: "repo", BranchName: "branch", OrgID: "org",
				TasFileName: "tas", BuildTargetCommit: "btg",
			}, coverageMode: false, locators: "../dummy"},
			true,
		},
		{
		...
		},
		{
			...
			validatePayloadArgs{ctx: context.TODO(), payload: &core.Payload{
				...
				GitProvider: "fake", BuildID: "build", RepoID: "repo", BranchName: "branch", OrgID: "org",
				TasFileName: "tas", BuildTargetCommit: "btg",
			}, coverageMode: false, locators: "../dummy", taskID: "tid"},
			true,
		},
		{
			...
			validatePayloadArgs{ctx: context.TODO(), payload: &core.Payload{
				RepoLink: "github.com/abc/", RepoSlug: "/slug",
				GitProvider: "fake", BuildID: "build", RepoID: "repo", BranchName: "branch", OrgID: "org",
				TasFileName: "tas", BuildTargetCommit: "btg", EventType: "invalid",
			}, coverageMode: true},
			true,
		},
		{
			...
			validatePayloadArgs{ctx: context.TODO(), payload: &core.Payload{
				RepoLink: "github.com/abc/", RepoSlug: "/slug",
				GitProvider: "fake", BuildID: "build", RepoID: "repo", BranchName: "branch", OrgID: "org",
				TasFileName: "tas", BuildTargetCommit: "btg", EventType: "push", Commits: []core.CommitChangeList{},
			}, coverageMode: true},
			true,
		},
		{
			...
			validatePayloadArgs{ctx: context.TODO(), payload: &core.Payload{
				...
				Commits: []core.CommitChangeList{{Sha: "sha", Message: "msg"}},
			}, coverageMode: true},
			false,
		},
	}
