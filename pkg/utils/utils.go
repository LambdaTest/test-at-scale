...
func GetArgs(command string, frameWork string, frameworkVersion int,
	...
	if language == "java" {
		if frameworkVersion != 0 {
			frameWork = "-Dframework=" + frameWork + strconv.Itoa(frameworkVersion)
		} else {
			frameWork = "-Dframework=" + frameWork
		}

		args = append(args, "test")
		if command == "discover" {
			args = append(args, global.JavaDiscoveryArgs...)
		} else {
			args = append(args, global.JavaExecutionArgs...)
		}
